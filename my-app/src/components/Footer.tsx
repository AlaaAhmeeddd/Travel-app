...
const Footer = () => {
    return (
        <footer className="flex items-center justify-center mb-24 mt-20">
        <div className="padding-container max-container flex w-full flex-col gap-14">
            ...
            <p className="text-[14px] font-[400] w-full text-center text-gray-30">2023 Hilink | All rights reserved</p>
        </div>
        </footer>
    )
}
